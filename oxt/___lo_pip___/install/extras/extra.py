...
class Extra(ABC):
    ...
    def _install_flatpak(self) -> bool:
        ...
        installer = InstallPkgFlatpak(flag_upgrade=self.flag_upgrade, show_progress=self.show_progress)
    ...
    def _install_default(self) -> bool:
        ...
        installer = InstallPkg(flag_upgrade=self.flag_upgrade, show_progress=self.show_progress)
        return installer.install(self._get_packages())
