...
class Greater(VerRuleBase):
    """
    A class to represent a Greater Than version.
    """
    ...
    def get_version_is_valid(self, check_version: str) -> int:
        """
        Check if the version is valid. check_version is valid if it is greater than the vstr.
