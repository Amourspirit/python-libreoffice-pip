...
from oxt.lo_pip.ver.rules.lesser import Lesser
...
def test_get_version_is_valid() -> None:
    ...
    assert rule.get_version_is_valid("1.2.5", ver) == 1
    assert rule.get_version_is_valid("1.3.0", ver) == 1
    assert rule.get_version_is_valid("2.0.0", ver) == 1
    assert rule.get_version_is_valid("1.2.3", ver) == 0
    assert rule.get_version_is_valid("0.0.3", ver) == 0
